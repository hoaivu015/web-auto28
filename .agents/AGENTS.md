...
**Veto Agents (không thể bị override bởi weight):** `landing-page-auditor`, `visual_inspector`, `structure_guardian`, `lang_standards_guardian`, `auto_technical_inspector`, `reflection_gate_agent`
