...
description: Kích hoạt khi task Auto 28 landing page phức tạp, đa bước hoặc không rõ scope. Phân loại độ phức tạp (Simple/Medium/Complex), phân tích rủi ro kỹ thuật, lập kế hoạch nguyên tử TRƯỚC khi viết code. Bắt buộc với mọi task có >2 file bị ảnh hưởng.
---
