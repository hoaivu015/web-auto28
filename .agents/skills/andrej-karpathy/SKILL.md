...
description: Áp dụng cho MỌI Write-Action trong dự án Auto 28 landing page (HTML/CSS/JS). Buộc Surgical Precision — chỉ sửa đúng dòng cần sửa, no over-engineering, no scope creep, style matching. Kích hoạt tự động trước bất kỳ thao tác sửa code nào.
---
