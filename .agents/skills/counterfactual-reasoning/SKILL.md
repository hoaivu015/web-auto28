...
description: Kích hoạt trước khi chốt giải pháp kiến trúc hoặc refactor lớn trong dự án Auto 28 landing page. Ép buộc so sánh ít nhất 2 phương án (A/B) kèm trade-offs trước khi cam kết. Ngăn chặn "giải pháp đầu tiên trong đầu" — sai sót phổ biến nhất của AI coding.
---
